"use strict";
const preset_elm = (document.getElementById("preset"));
let key_name;
...
function generatePattern() {
    let preset_name = prompt("プリセット名を入力してください", "無題のプリセット");
    if (typeof preset_name !== "string")
        throw alert("キャンセルされました。");
    let w_min = prompt("集中したい分数を入力してください", "0");
    if (typeof w_min !== "string")
        throw alert("キャンセルされました。");
    let w_sec = prompt("集中したい秒数を入力してください", "0");
    if (typeof w_sec !== "string")
        throw alert("キャンセルされました。");
    let b_min = prompt("休憩したい分数を入力してください", "0");
    if (typeof b_min !== "string")
        throw alert("キャンセルされました。");
    let b_sec = prompt("休憩したい秒数を入力してください", "0");
    if (typeof b_sec !== "string")
        throw alert("キャンセルされました。");
